...
<body>
    ...
    <div class="main-content">
        <div class="header">
            <form action="t-student-account-archived.php"method="post">
                <div>
        ...
        <?php
            ...
            if(isset($_POST['btnfilter']))
            {
                ...
                $querydisplay ="SELECT * FROM users WHERE Section ='$section' AND Status ='Inactive' ORDER BY Lastname ASC";
                            ...
                            <div class="account-item">
                                ...
                                <div>
                                    ...
                                    <form action="t-student-account-archived.php" method="POST">
                                        ...
                                        <input type="hidden" name="editGender" value="<?php echo $row['Gender']?>">
                                        <input type="hidden" name="editSection" value="<?php echo $row['Section']?>">
                                        <button name="btnarchive">Activate Account</button>
                                    </form>
                                </div>
                            </div>
                        </div>
                ...
                {
                     echo "<center><h1 class='alert alert-danger'> No Archived accounts in this section !</h1></center>";
                }
            }
            else if (isset($_POST['btnarchive']))
            {
                $activeID = $_POST['editID'];
                $queryArchiveDetails = "UPDATE users SET Status ='Active' WHERE ID = '$activeID'";
                $queryArchiveAccounts = "UPDATE accounts SET Status ='Active' WHERE ID = '$activeID'";
                ...
                {
                    echo "<script>alert('Activation Successfully');</script>";
                    echo"<script>
                        setTimeout(function(){
                            window.location.href = 't-student-account-archived.php'; // Replace with your target page
                        }, 1000); // 1000 milliseconds = 1 second
                    </script>";
                }
                else
                {
                    echo "<center><h1 class='alert alert-success'>Account Activation FAILED !</h1></center>";
                }

            }
            else
            {
                echo "<center><h1 class='alert alert-danger'>Please select a section to see Archived created accounts </h1></center>";
            }
        ?>
