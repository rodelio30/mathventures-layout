        ...
        <div class="right">
            ...
            <?php
                ...
                if(isset($_POST['btnlogin']))
                {
                    ...
                    // $sql = "SELECT * FROM accounts WHERE Username ='$username' AND Password ='$password' AND Usertype = 'admin' AND Status ='Active'";
                    // $sqli_run = mysqli_query($con,$sql);

                    // $sql2 = "SELECT * FROM accounts WHERE Username ='$username' AND Password ='$password' AND Usertype = 'student' AND Status ='Active'";
                    // $sqli_run2 = mysqli_query($con,$sql2);

                    // if (mysqli_num_rows($sqli_run) > 0) 
                    // {
                    //     echo "<script> alert('LOGIN SUCCESSFULLY !')</script>";
                    //     echo "<script> window.location.href = 'teacher/t-dashboard.php';</script>";
                    // }
                    // else if(mysqli_num_rows($sqli_run2) > 0)
                    // {
                    //     echo "<script> alert('LOGIN SUCCESSFULLY !')</script>";
                    //     echo "<script> window.location.href = 'player/student-dashboard.php';</script>";
                    // } 
                    // else 
                    // {
